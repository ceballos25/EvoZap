<?php
//Encabezado
include "templeate/header.php";
?>

          <!-- inicia c ontenido del centro-->
          <main>
            <!-- Content header -->
              ...
              <div class="grid grid-cols-1 gap-8 p-4 lg:grid-cols-2 xl:grid-cols-4">
                ...
                <div class="flex items-center justify-between p-4 bg-white rounded-md dark:bg-darker">
                  <div>
                    ...
                    <span class="text-xl font-semibold">1504</span>
                  </div>
                  <div>
                  <span>
                      <svg
                ...
                <div class="flex items-center justify-between p-4 bg-white rounded-md dark:bg-darker">
                  <div>
                    ...
                    <span class="text-xl font-semibold">28</span>
                  </div>
                  <div>
                    <span>
                      <svg
        ...
        <!-- finaliza c ontenido del centro-->

<?php
//Footer
include "templeate/footer.php";
?>