...
<html lang="es">
   ...
   <body>
         ...
         <div class="container">
            <div class="row">
               <div class="col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2 col-lg-6 col-lg-offset-3 form-box">
                  <form role="form" action="funciones/registro.php" method="post" class="f1" id="miFormulario">
                     <h3>Registro Entrenamiento</h3>
                     <h5>19, 20, y 21 de Enero de 2024</h5>
                     <div class="f1-steps">
                     ...
                     <fieldset>
                        ...
                        <div class="form-group d-flex">
                           ...
                           <select class="form-select d-flex tipo-doc" id="">
                        ...
                        <div class="form-group">                                    
                           <textarea name="f1-about-yourself" placeholder="Menciona cuatro (4) objetivos que deseas lograr con este entrenamiento.." class="f1-about-yourself form-control" id="f1-about-yourself"></textarea>
                        </div>
                        ...
                        <input class="form-control pading" type="text" list="datalistOptions" id="exampleDataList">
                     ...
                     <br>
                     <div class="form-group">
                     <input type="text" name="cedula-referido" placeholder="Cedula, de la persona que te invitó" class="f1-email form-control numero-documento" id="cedula-referido">
                     </div>
                     <div class="f1-buttons">
                     ...
                     <li>Con el envío del presente formulario, te comprometes a participar en este entrenamiento según lo programado.</li><br>
                     <li>La cuota mínima de inscripción es de $200.000, la cual no es reembolsable.</li><br>
                     <li>En caso de no asistir al entrenamiento  por causa de fuerza mayor o caso fortuito demostrable, podrás conservar tu cupo o hacer uso de la transferencia para el próximo entrenamiento inmediatamente siguiente. Debes tener en cuenta, enviar los soportes correspondientes al whatsapp de ECO, máximo 3 días hábiles siguientes a la ocurrencia del suceso para poder hacer uso del cupo.</li><br>
                     <li>Si eliges no hacer uso del cupo para tu entrenamiento, podrás solicitar reembolso del 20% del valor pagado.</li><br>
                     <li>Las transferencias de cupo debe hacerse al mismo taller, Básico y básico, avanzado a avanzado, y de PL a PL.</li><br>
                     <li>Solo se permite una transferencia por persona.</li><br>
      ...
      <script src="https://cdn.jsdelivr.net/npm/bootstrap@3.4.1/dist/js/bootstrap.min.js" integrity="sha384-aJ21OjlMXNL5UyIl/XNwTMqvzeRMZH2w8c5cRVpzpU8Y5bApTppSuUkhZXN0VxHd" crossorigin="anonymous"></script>        <script src="assets/js/jquery.backstretch.min.js"></script>
